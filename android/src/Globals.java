...
class Globals
{
	...
	public static String ApplicationName = "Ballfield";
	public static String AppLibraries[] = { "sdl-1.2", "sdl_image" };
	public static final boolean Using_SDL_1_3 = false;
	public static String[] DataDownloadUrl = { "!!Game data is 1 Mb|ballfield3.zip",  };
	...
	public static boolean AppUsesSecondJoystick = true;
	public static boolean AppUsesAccelerometer = true;
	public static boolean AppUsesGyroscope = true;
	...
	public static Settings.Menu FirstStartMenuOptions [] = { new Settings.ShowReadme(), (AppUsesMouse && ! ForceRelativeMouseMode ? new Settings.DisplaySizeConfig(true) : new Settings.DummyMenu()), new Settings.OptionalDownloadConfig(true), new Settings.GyroscopeCalibration() };
